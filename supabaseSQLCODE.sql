...
-- -- Modify LibraryBooks table to add constraints
-- ALTER TABLE LibraryBooks
-- ALTER COLUMN PublishedYear SET NOT NULL,
-- ADD COLUMN Genre VARCHAR(30) DEFAULT 'Fiction',
-- ADD CONSTRAINT chk_published_year CHECK (PublishedYear BETWEEN 1900 AND EXTRACT(YEAR FROM CURRENT_DATE));
...
-- -- Create Borrowing table with foreign keys
...
-- -- Drop Genre column and remove CHECK constraint from LibraryBooks
-- ALTER TABLE LibraryBooks
-- DROP COLUMN Genre,
-- DROP CONSTRAINT chk_published_year;
